#!/bin/bash
#
#SBATCH --job-name=PS2Interface # give a meaningful name.
#SBATCH --error=sherlock_output/PS2Interface.err
#SBATCH --out=sherlock_output/PS2Interface-1-%j.out
