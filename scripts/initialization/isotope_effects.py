...
class IsotopeEffects:
    ...
    def __init__(self):
        ...
        self.alpha15NH4TON2OaAOA = ( -21.3 / 1000 + 1 )  # AOA, Santoro et al., 2011 (adjusted based on δ15NH4+ value)
        self.alpha15NH4TON2ObAOA = ( 9.0 / 1000 + 1 )  # AOA, Santoro et al., 2011 (adjusted based on δ15NH4+ value)
