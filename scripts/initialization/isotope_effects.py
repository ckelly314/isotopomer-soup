...
class IsotopeEffects:
	...
	def __init__(self):
		...
		self.alpha15NH4TON2Oa = -21.3/1000 + 1 # AOA, Santoro et al., 2011 (adjusted based on δ15NH4+ value)
		self.alpha15NH4TON2Ob = 9.0/1000 + 1 # AOA, Santoro et al., 2011 (adjusted based on δ15NH4+ value)
		self.alpha15NH4TON2O46 = (self.alpha15NH4TON2Oa + self.alpha15NH4TON2Ob)/2

		self.alpha15NOxTON2Oa = 22./1000.+1 # Toyoda et al., 2005
		self.alpha15NOxTON2Ob = 22./1000.+1 # Toyoda et al., 2005
		self.alpha15NOxTON2O46 = 22./1000.+1 # Toyoda et al., 2005

		self.alpha15NH4TONO2 = 22./1000+1 # AOA, Santoro and Casciotti, 2011
		self.alpha15NO2TONO3 = -15./1000+1 # Casciotti, 2009
		self.alpha15NO3TONO2 = 5./1000+1 # Granger et al., 2004

		self.alpha15N2OatoN2 = 11.8/1000.+1 # Kelly et al., 2021
		self.alpha15N2ObtoN2 = 0./1000.+1 # Kelly et al., 2021
		self.alpha46N2OtoN2 = 11.8/1000.+1 # assume this is the same as the alpha effect
