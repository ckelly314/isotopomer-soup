...
def run(station, feature):
    ...
    saveout = np.array(
        [
            outputNH4[
                ["nitrification", "denitno2", "denitno3", "hybrid1", "hybrid2"]
            ].mean(),
            outputNO2[
                ["nitrification", "denitno2", "denitno3", "hybrid1", "hybrid2"]
            ].mean(),
    ...
    modeloutput = pd.read_excel("scripts/data/SP_tests.xlsx", index_col="Key")
    ...
    scatter_plot(
        ...
        filename=f"Figures/{stn}{ft}NH4+modelv1.pdf",
    )
    ...
    scatter_plot(
        ...
        filename=f"Figures/{stn}{ft}NO2-modelv1.pdf",
    )
    ...
    scatter_plot(
        ...
        filename=f"Figures/{stn}{ft}NO3-modelv1.pdf",
    )
