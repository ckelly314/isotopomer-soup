#!/bin/bash
#
#SBATCH --job-name=PS2Deepoxycline # give a meaningful name.
#SBATCH --error=sherlock_output/PS2Deepoxycline.err
#SBATCH --out=sherlock_output/PS2Deepoxycline-1-%j.out
