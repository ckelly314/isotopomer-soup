#!/bin/bash
#
#SBATCH --job-name=PS2DeepODZcore # give a meaningful name.
#SBATCH --error=sherlock_output/PS2DeepODZcore.err
#SBATCH --out=sherlock_output/PS2DeepODZcore-1-%j.out
