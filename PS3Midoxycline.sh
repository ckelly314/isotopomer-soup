#!/bin/bash
#
#SBATCH --job-name=PS3Midoxycline # give a meaningful name.
#SBATCH --error=sherlock_output/PS3Midoxycline.err
#SBATCH --out=sherlock_output/PS3Midoxycline-1-%j.out
