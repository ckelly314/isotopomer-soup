#!/bin/bash
#
#SBATCH --job-name=PS3Interface # give a meaningful name.
#SBATCH --error=sherlock_output/PS3Interface.err
#SBATCH --out=sherlock_output/PS3Interface-1-%j.out
