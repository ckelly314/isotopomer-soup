#!/bin/bash
#
#SBATCH --job-name=PS2BaseofODZ # give a meaningful name.
#SBATCH --error=sherlock_output/PS2BaseofODZ.err
#SBATCH --out=sherlock_output/PS2BaseofODZ-1-%j.out
