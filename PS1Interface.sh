#!/bin/bash
#
#SBATCH --job-name=PS1Interface # give a meaningful name.
#SBATCH --error=sherlock_output/PS1Interface.err
#SBATCH --out=sherlock_output/PS1Interface-1-%j.out
