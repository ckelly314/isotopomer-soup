#!/bin/bash
#
#SBATCH --job-name=PS3Topofoxycline # give a meaningful name.
#SBATCH --error=sherlock_output/PS3Topofoxycline.err
#SBATCH --out=sherlock_output/PS3Topofoxycline-1-%j.out
