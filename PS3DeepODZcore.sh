#!/bin/bash
#
#SBATCH --job-name=PS3DeepODZcore # give a meaningful name.
#SBATCH --error=sherlock_output/PS3DeepODZcore.err
#SBATCH --out=sherlock_output/PS3DeepODZcore-1-%j.out
