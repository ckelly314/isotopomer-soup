#!/bin/bash
#
#SBATCH --job-name=PS1Midoxycline # give a meaningful name.
#SBATCH --error=sherlock_output/PS1Midoxycline.err
#SBATCH --out=sherlock_output/PS1Midoxycline-1-%j.out
