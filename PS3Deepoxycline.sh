#!/bin/bash
#
#SBATCH --job-name=PS3Deepoxycline # give a meaningful name.
#SBATCH --error=sherlock_output/PS3Deepoxycline.err
#SBATCH --out=sherlock_output/PS3Deepoxycline-1-%j.out
