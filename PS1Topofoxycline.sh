#!/bin/bash
#
#SBATCH --job-name=PS1Topofoxycline # give a meaningful name.
#SBATCH --error=sherlock_output/PS1Topofoxycline.err
#SBATCH --out=sherlock_output/PS1Topofoxycline-1-%j.out
