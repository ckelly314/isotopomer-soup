#!/bin/bash
#
#SBATCH --job-name=PS3Interface2 # give a meaningful name.
#SBATCH --error=sherlock_output/PS3Interface2.err
#SBATCH --out=sherlock_output/PS3Interface2-1-%j.out
